...
-- @classmod naughty.list.notifications
...
--- Restrict the list to notifications attached to this client.
--
-- Note that this will only works when no filters are applied. The explicit
-- filter always have priority over this.
--
-- @property client
-- @see filter
...
-- \/ If you wonder why it is "base_layout" and not "layout", it is because of
-- a conflict with the declarative syntax.
...
-- @tparam client args.client Create a notification list only for that client.
-- @tparam client args.clients Create a notification list only for those clients.
-- @tparam client args.tag Create a notification list only for that tag.
-- @tparam client args.tags Create a notification list only for those tags.
-- @tparam client args.screen Create a notification list only for that screen.
...
-- @function naughty.list.notifications
...
--TODO these filters require the GDBus port of the XDG notification handling to
-- get the sender PID (and thus its attached clients)

-- ---
-- -- @param n The notification.
-- -- @return True if the notification is owned by a client in these tags **or**
-- --  if there is no attached clients.
-- -- @filterfunction naughty.list.notifications.filter.tags
-- function module.filter.tags(n, tags)
--     return true
-- end

-- ---
-- -- @param n The notification.
-- -- @return True if the notification is owned by a client in these screens **or**
-- --  if there is no attached clients.
-- -- @filterfunction naughty.list.notifications.filter.screen
-- function module.filter.screens(n, screens)
--     return true
-- end

-- ---
-- -- @param n The notification.
-- -- @return True if the notification is owned by a client in these clients.
-- -- @filterfunction naughty.list.notifications.filter.clients
-- function module.filter.clients(n, clients)
--     return true
-- end
