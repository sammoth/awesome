...
--
-- By default, the box is composed of many other wisgets:
--
--@DOC_wibox_nwidget_default_EXAMPLE@
--
-- @author Emmanuel Lepage Vallee &lt;elv1313@gmail.com&gt;
-- @copyright 2017 Emmanuel Lepage Vallee
-- @classmod naughty.layout.box
----------------------------------------------------------------------------
...
-- Init the weak tables for each positions. It is done AOT rather than when
-- notifications are added to simplify the code.
